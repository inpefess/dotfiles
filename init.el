...
(custom-set-variables
 ...
 '(before-save-hook (quote (py-isort-before-save elpy-black-fix-code)))
...
"))))
 ...
 '(org-trello-files (quote ("~/.trello.org")) nil (org-trello))
 '(package-archives
   (quote
